...
| 2 | API Layer | REST endpoints for CRUD operations on question sets, questions, and recording study attempts | pending |
| 3 | Frontend Shell | App layout with navigation, routing between views, and question set list display | pending |
| 4 | File Upload | Drag-and-drop JSON file upload with validation, filename-based naming, and custom name input | pending |
